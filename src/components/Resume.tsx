          ...
          <div className="row">
            ...
            <div className="col-lg-6">
              ...
              <div className="mt-4 d-flex align-items-center justify-content-center">
                <a href="https://muhaiminsalayk.netlify.app/Abdul_Muhaimin_Salay_Kanton_Resume.pdf" target="_blank" rel="noreferrer noopener" download title="Abdul Muhaimin Salay Kanton Resume" className="btn btned py-3 px-4"> <i className="bi bi-file-earmark-arrow-down" /> Download My Resumé</a>
              </div>
          </div>
        </div>
      </section>
